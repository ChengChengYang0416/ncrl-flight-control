...
void force_ff_ctrl_use_adaptive(float *accel_ff, float *force_ff, float *pos_err, float *vel_err){
...
void moment_ff_ctrl_use_adaptive(float *mom_ff){
...
#elif (SELECT_FEEDFORWARD == FEEDFORWARD_USE_ADAPTIVE)
	force_ff_ctrl_use_adaptive(accel_ff_ned, force_ff_ned, pos_error, vel_error);
#endif
...
#elif (SELECT_FEEDFORWARD == FEEDFORWARD_USE_ADAPTIVE)
	moment_ff_ctrl_use_adaptive(moment_ff);
#endif
